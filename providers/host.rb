...
def create_host_config
  ...
  host_config['children']                       = new_resource.children                     unless new_resource.children.nil?
  host_config['contact_groups']                 = new_resource.contact_groups               unless new_resource.contact_groups.nil?
  host_config['contacts']                       = new_resource.contacts                     unless new_resource.contacts.nil?
  ...
  host_config['flap_detection_options']         = new_resource.flap_detection_options       unless new_resource.flap_detection_options.nil?
  ...
  host_config['hostgroups']                     = new_resource.hostgroups                   unless new_resource.hostgroups.nil?
  ...
  host_config['notification_options']           = new_resource.notification_options         unless new_resource.notification_options.nil?
  ...
  host_config['parents']                        = new_resource.parents                      unless new_resource.parents.nil?
  ...
  host_config['stalking_options']               = new_resource.stalking_options             unless new_resource.stalking_options.nil?
